...
import com.noirix.security.requests.AuthRequest;
import com.noirix.security.requests.AuthResponse;
...
public class AuthenticationController {
    ...
    @PostMapping
    public ResponseEntity<AuthResponse> loginUser(@RequestBody AuthRequest request) { //, @ApiIgnore Principal principal) // - можно вытянуть информацию, но в данном случае не нужен
